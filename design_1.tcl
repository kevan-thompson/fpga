...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_CLK100MHZ_100M, and set properties
  set rst_CLK100MHZ_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_CLK100MHZ_100M ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins microblaze_0/M_AXI_DC] [get_bd_intf_pins microblaze_0_axi_periph/S01_AXI]
  ...
  connect_bd_net -net Net1 [get_bd_ports ddr3_dqs_p] [get_bd_pins mig_7series_0/ddr3_dqs_p]
  connect_bd_net -net Net2 [get_bd_ports ddr3_dqs_n] [get_bd_pins mig_7series_0/ddr3_dqs_n]
  connect_bd_net -net Net3 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins mig_7series_0/clk_ref_i] [get_bd_pins mig_7series_0/sys_clk_i]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports uart_rxd_out] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net ck_rst_1 [get_bd_ports ck_rst] [get_bd_pins rst_CLK100MHZ_100M/ext_reset_in] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins vio_0/probe_in2]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_CLK100MHZ_100M/mb_debug_sys_rst] [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_axi_periph/S02_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_CLK100MHZ_100M/slowest_sync_clk] [get_bd_pins vio_0/clk]
  ...
  connect_bd_net -net rst_CLK100MHZ_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_CLK100MHZ_100M/bus_struct_reset]
  connect_bd_net -net rst_CLK100MHZ_100M_interconnect_aresetn [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins rst_CLK100MHZ_100M/interconnect_aresetn]
  connect_bd_net -net rst_CLK100MHZ_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins rst_CLK100MHZ_100M/mb_reset] [get_bd_pins vio_0/probe_in3]
  connect_bd_net -net rst_CLK100MHZ_100M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S02_ARESETN] [get_bd_pins rst_CLK100MHZ_100M/peripheral_aresetn]
  ...
  connect_bd_net -net rx_1 [get_bd_ports uart_txd_in] [get_bd_pins axi_uartlite_0/rx]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
